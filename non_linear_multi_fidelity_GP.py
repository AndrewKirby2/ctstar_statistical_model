...
print('MAE = ',np.mean(100*np.abs(ctstar_statistical_model-training_data[:,3]))/0.75,'%')
print('MAE = ',np.mean(np.abs(ctstar_statistical_model-training_data[:,3])))
print('Max error = ',np.max(100*np.abs(ctstar_statistical_model-training_data[:,3]))/0.75,'%')

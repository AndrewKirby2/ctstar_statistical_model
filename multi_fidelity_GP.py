...
wake_model = np.genfromtxt('wake_model_results_2000.csv', delimiter=',')
...
np.savetxt('ctstar_statistical_model_2000.csv', ctstar_statistical_model, delimiter=',')
np.savetxt('ctstar_statistical_model_std_2000.csv', ctstar_statistical_model_std, delimiter=',')

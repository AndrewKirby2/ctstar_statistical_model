...
stat_model_mean = np.genfromtxt('ctstar_nonlin_statistical_model_500.csv', delimiter=',')
stat_model_std = np.genfromtxt('ctstar_nonlin_statistical_model_std_500.csv', delimiter=',')
